...
describe("todoService", () => {
  ...
  describe("#create", () => {
    ...
    it("should save todo item with late status whn the property is further than today", () => {
      const properties = {
      ...
      const expetedCallWith = { ...data, status: "late" };

      expect(
        todoService.todoRepository.create.calledOnceWithExactly(expetedCallWith)
      ).to.be.ok;
    });
    ...
    it("should save todo item with pending status", () => {
      ...
      const expetedCallWith = { ...data, status: "pending" };
